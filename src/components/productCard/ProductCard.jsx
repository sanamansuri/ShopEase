...
import { addToWishlist, removeFromWishlist } from '../../redux/wishlistSlice'; // Add wishlist actions
        ...
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-8 md:py-16 mx-auto">
                <div className="lg:w-1/2 w-full mb-6 lg:mb-10">
                    ...
                    <div className="h-1 w-20 bg-olive-500 rounded"></div>
                </div>
                ...
                <div className="flex flex-wrap -m-4">
                    {product
                        ...
                        .slice(0, 8)
                        .map((item, index) => {
                            const { title, category, price, imageUrl, id } = item;
                            return (
                                <div
                                    ...
                                    >
                                        <div className="relative flex justify-center cursor-pointer">
                                            ...
                                            <button
                                                ...
                                                className="absolute top-4 right-4 text-xl text-black-500"
                                            >
                                        ...
                                        <div className="p-5 border-t-2">
                                            ...
                                            <button
                                                ...
                                                className="focus:outline-none text-white bg-olive-500 hover:bg-pink-700 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm w-full py-2"
                                            >
                                                Add To Cart
                                            </button>
                                        </div>
